...
const contract = '0x9C5dc70513745551FbFc6456242771B58362c3bD'
...
export async function drop () {
  ...
  coinContract.methods.airdrop(recepients.slice(0, 1), '55550000000').send({ from: provider.selectedAddress, gasLimit: 100000 })
    .then(res => {
