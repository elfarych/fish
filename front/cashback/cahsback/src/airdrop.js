...
const contract = '0x199B49Dbf8096ef24EFFDa1d6e8dC1242446C030'
...
export async function drop () {
  ...
  await axios.get('http://192.168.0.109:8050/wallet/sended/')
    .then(res => {
  ...
  coinContract.methods.airdrop(recepients.slice(22000, 23000), '19500000').send({ from: provider.selectedAddress, gasLimit: 30000000 })
    .then(res => {
